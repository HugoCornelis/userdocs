...
during the model construction phase.  The model-container provides an addressing algorithm to obtain the addresses of
solved variables from the different solvers independently of their
scale [see cbi-multiscale for details].  In principle this functionality
allows instantiation of efficient communication components that can embed any required numerical scheme or algorithm necessary for upscaling or downscaling variables or other aspects of the integrated model.  This feature is essential for the implementation of scale-linking.

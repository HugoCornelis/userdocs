...
project\marginpar{way to many occurences of 'this project'} involve implementation of the tools to support cross linking and embedding of finer scale simulation
...
of G-3 supports this kind of functionality, at present there is only support for expansion
  of the scope of the upper or biological layer (see Fig.\,\ref{fig:cbi-architecture-expanded}) as the current NIH grant is

...
The GENESIS perfect clamp utility provides a simple but ``perfect'' voltage clamp to one or more specified compartment(s) of a neuronal morphology. Here we describe how to use it from the \href{../introduction-gshell/introduction-gshell.tex}{GENESIS shell}. Here, we assume that you are familiar with the contents of the following GENESIS documentation: \href{../tutorial1/tutorial1.tex}{Tutorial 1} and \href{../tutorial1/tutorial2.tex}{Tutorial 2}.

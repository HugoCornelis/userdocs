...
\begin{figure}[h]
  \centering
 \includegraphics[scale=0.4]{figs/BoGfig5_4s.eps}
  %\caption{enumerate}
...
Further details of the process of constructing realistic single cell models are given in a tutorial paper by \href{../jaeger-tutorial/jaeger-turotial.pdf}{Jaeger (2005)}.

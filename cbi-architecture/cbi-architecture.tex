...
words, it is the technology that defines the scope and boundaries of
software solutions.  As a consequence the development of entirely new
software architectures can only be started from the lowest layer and
built up to meet user requirements.  In traditional enterprise
software applications the lowest layer consists of database back-ends.
However the CBI architecture has numerical solvers as back-ends.

The software implementation of a CBI compliant simulator can best be
started with the implementation of a numerical solver.
...
languages, as opposed to low-level languages\,\cite{1118892}.  This
allows to improve the support for user-workflow and provides a richer
user-experience.

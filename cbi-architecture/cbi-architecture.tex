...
As a consequence such simulators frequently expose these mathematical structures,
thereby making the user responsible for them during the construction of network models. This violates
the data-layering principles identified by our separation of concerns.

...
state.  These events also direct the different components to
pass data amongst themselves.  Such interactions define the overall behaviour of a software
system.  In this section we explain how user

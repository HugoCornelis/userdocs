...
basis of a separation of concerns (described in Materials and
...
2 neural simulation system, described in a accompanying paper.
...
architecture. We now introduce their functionality and describe their relationships within the context of the user workflow\marginpar{user workflow not defined here}.\\

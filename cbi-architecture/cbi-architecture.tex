...
state.  This interaction defines the overall behaviour of the software
system.  The family of events also directs the different components to
pass data amongst themselves.  In this section we explain how user
actions and data flows relate to one another in the CBI architecture.

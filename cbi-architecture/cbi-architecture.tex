...
The behaviour of the CBI architecture is defined by the join of the
functions provided by each individual module.

We now describe the relationships of the various software
modules that support their behaviour within the context of our ideal
user workflow.\\

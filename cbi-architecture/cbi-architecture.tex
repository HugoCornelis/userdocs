...
Steps 4 and 5 are complementary to the first three steps of the ideal
user workflow.
...
Because the cycle between databases and files in steps 1-3 and the all
model data is available through the model-container.  For these
reasons {\tt Scripting\,Libraries\,\&\,Applications} may readily be
interfaced with the CBI architecture at step 4 and 5 while maintaining
the integrity of the CBI architecture by the separation of concerns.

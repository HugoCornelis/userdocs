...
The other steps of the ideal user workflow fall outside the scope of
the CBI architecture.  Output analysis is typically done with a tool
such as Matlab.  The last step of the ideal user workflow (Iterate)
closes the loop between the output of results and a new phase of model
construction.

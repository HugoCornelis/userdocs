...
As\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){120}}
  \end{picture}
} many more data flows can exist than are present in reality, each actual
...
inspiration from this\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){160}}
  \end{picture}
} partitioning.
...
{\tt Model\,Containers}\footnote{For\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){20}}
  \end{picture}
} simplicity, where appropriate, we collectively refer to the {\tt Biology\,Model\,Container} and the {\tt Experiment\,Model\,Container} as the {\tt Model\,Containers}.} via a low-level {\it application binary interface}
...
GNU Scientific Library (http://www.gnu.org/s/gsl/)\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){20}}
  \end{picture}
}, the Perl Data
...
% Figure 4
\noindent{\bf Place Figure\,\ref{fig:cbi-architecture-expanded} about here.}\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){20}}
  \end{picture}
}\\
...
the spatial layout of segments\footnote{`Segment'\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){20}}
  \end{picture}
} is a high level term employed to describe different parts of the biological model of a dendritic morphology. The equivalent low level (computational) term is `compartment'. It refers to the numerical representation of a segment.} as this is not required by the {\tt
  Solvers}.  This\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){600}}
  \end{picture}
...
The\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){80}}
  \end{picture}
} term {\it user workflow} is employed to describe the sequence of necessary steps typically employed by a person in developing a computational model and employing simulation to generate data for subsequent analysis. In this sense it is a depiction of a sequence of operations, declared as the work of a person or a group of persons \cite{Belhajjame:2001fv}.

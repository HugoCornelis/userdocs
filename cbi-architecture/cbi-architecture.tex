...
result of choices by the modeler.  Examples of these choices are the
choice of algorithms such as the numerical method, or the value of
parameters, such as maximal electrotonic length.  Many of these
choices have an underpinning given by the phenomenological experiments
in neuroscience.  Examples here are the choice of Hodgkin and Huxley
to hypothesize the existence of transmembrane ion channels that can be
blocked by biophysical gates and mathematically represent the activity
of these gates with fitted exponentials raised to a power.  This
hypothesis structured a rich scientific discourse about the

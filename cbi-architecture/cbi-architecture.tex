...
Its independence of technology facilitates communication about similar
concepts and functions.  It has important advantages for multiple
independent contributions to software development.  Importantly this
includes: (1) Complexity of individual simulator components is reduced
compared to the complexity of a complete simulator, (2) Components can
be documented in isolation, in terms of their inputs and outputs, (3)
Unnecessary or obsoleted components can be easily replaced or removed,
(4) Components can be tested stand-alone, and (5) The architecture
clearly delineates the development scope of new components.

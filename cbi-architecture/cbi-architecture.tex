...
As a consequence such simulators expose these mathematical structures
to the user when constructing large network models thereby violating
the data-layering principle of the CBI architecture.

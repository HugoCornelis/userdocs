...
comprehensive user workflow can be employed by simulator users.

Systematic organization 
As a tool to help scientist

A comprehensive user workflow that can be employed by simulator users
as a guide to separate and distinguish the different aspects of the
control code of the simulator software.  The

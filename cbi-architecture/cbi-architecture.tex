...
Dedicated industry standards have been developed for SOAs that allow
routine implementation of business logic with an optimal
user-experience.  For example BPEL\marginpar{allan} is a common
industry standard that was approved by the industry in 2007, and is in
...
SED-ML \cite{Kohn:2008kx}.  SOAs often store control tables for

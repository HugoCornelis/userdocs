...
This is in sharp contrast with the CBI architecture.  Through its {\tt
  Scripting\,Libraries} and {\tt Communication} modules it provides
explicit support for control functions throughout all the layers of a

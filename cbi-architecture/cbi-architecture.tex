...
new solvers was not possible because its basic architecture was not properly\marginpar{from sufficiently} modularized to
allow it.
...
implementation of the procedural paradigm.  After the decade of the monoliths it makes the modeler's work even more complicated.\marginpar{Allan}

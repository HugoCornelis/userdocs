...
In step 1 of the ideal user workflow, the GUI is opened and a cell model is selected from a database listing of available models.
...
In step 2 of the ideal user workflow the user designs, as a simple example, an experiment

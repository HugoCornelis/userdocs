...
{\it Control tables} \marginpar{Italicized but undefined in Methods.}are sometimes to store meta-data and used to
...
addressed as interoperability between stand-alone\marginpar{What does `its resolution' refer to here?}

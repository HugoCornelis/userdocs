...
These libraries have a very defined focus, e.g. investigation of a
synaptic learning rule.  They are typically implemented directly
specific for a set of research or tutorial simulations.  They can
connect a model to a series of stimulus paradigms using a procedural
paradigm.  There are also `glue' functions to connect to external
libraries for other activities such as result analysis.  the GNU
Scientific Library (GSL), the Perl Data Language, and the Scientific
Library for Python.

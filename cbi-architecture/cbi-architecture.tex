...
many intermediate representations.  Each of these representations is
determined by the choices of the modeler.  Examples are the value of a
parameter, such as the maximal electrotonic length of a compartment,
or the chosen algorithm such as the numerical method.  Sometimes these
choices have an underpinning given by the phenomenological experiments
in neuroscience.  A good example of this is the hypothesis of Hodgkin
and Huxley of the existence of transmembrane ion channels that can be

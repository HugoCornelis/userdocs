...
consists of database engine back-ends.  Database engines use both
specialized and general algorithms and data structures for information
query optimization and optimal run-time performance.  This highly
active research area, intimately related with research into sorting
...
databases\marginpar{refs?? in this para}.  In these architectures {\it
  control tables} are sometimes used to implement user
workflows\cite{humby07:_progr}.

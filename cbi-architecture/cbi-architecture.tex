...
The\marginpar{Allan} separation of the steps for biological model
construction and experiment design allows the modeler to build
libraries of biological models and libraries of experimental
protocols.  In principle this allows to combine any model with any
appropriate experimental protocol without the requirement that the
experimental protocol was specifically designed for the chosen model.
We discuss the consequences of this type of application further
below\marginpar{where?}.
...
defined by both model structure and model quantities\marginpar{is defined by the history of its structure and of its quantities}.
%  Since
...
by a modeler can potentially lead to models that have physiologically
...
allows to evaluate the quantities against their valid physiological
range.

The development of separate libraries of biological models and
experimental protocols allows in principle to determine whether the
behavior of a model after application of an appropriate experimental
protocol is realistic.  The automation of this process would be useful
to identify the strengths, weaknesses, or deficits of a specific model
version.
...
with a model necessary to understand why certain modifications have
been made.  As a consequence the reason for these modifications often
remains unclear.
...
development.  Another class of annotation provides a version of a

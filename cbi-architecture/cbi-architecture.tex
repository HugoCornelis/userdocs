...
becomes a much more tangible reality.  After the {\it API}s of the CBI
architecture are defined, it is possible to specify the
compliance level of other simulators and software components by matching APIs.  It is
...
The\marginpar{Allan: mush up here and following} three-tier software

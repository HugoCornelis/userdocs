...
guaranteeing the correct behaviour of software.  Here, we propose there
...
extensibility, openness, and the possibility of highly optimised
performance. 
...
taken on a biological model. For simplicity, we collectively refer to the {\tt Biology\,Model\,Container} and the {\tt Experiment\,Model\,Container} as the {\tt Model\,Containers}.
...
architecture and define the overall behaviour of an implemented
software system.
...
the spatial layout of segments as this is not required by the {\tt
  Solvers}.  This behaviour is different from that of existing

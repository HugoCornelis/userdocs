...
concerns (described in Materials and Methods where the definition of
terms is also given).  We then describe the software modules resulting
from this analysis.  The CBI architecture is a principle result of a

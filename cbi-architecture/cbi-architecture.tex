...
Steps 4 and 5 of the ideal user workflow are technically unrelated to
a simulation run and may fall outside the scope of the CBI
architecture.  On the other hand {\tt
  Scripting\,Libraries\,\&\,Applications} may connect to external

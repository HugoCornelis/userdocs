...
back-end {\tt Solver}s.  Above we have shown this cycle for a network
and single neuron model, but it also occurs for models at different
scales, including hybrid and multi-scale models.

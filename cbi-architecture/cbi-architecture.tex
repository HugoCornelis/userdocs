...
simulation system that was developed on the basis of our understanding of a general scientific workflow\marginpar{\bf Hugo, this does not seem to be an appropriate reference.}, an {\it ideal user
...
specific for a set of research or tutorial simulations. They connect a 
model to a series of stimulus paradigms using a procedural paradigm,
for example a library of stimulus paradigms representing in-vitro and
in-vivo conditions of a Purkinje cell model.
...
Library (http://www.gnu.org/s/gsl/), the Perl Data Language
(http://pdl.perl.org/), and the Scientific Library for Python

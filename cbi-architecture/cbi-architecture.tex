...
{\tt Scripting\,Libraries} and Communication components it\marginpar{Need to replace Communication components with the appropriate modules in Fig. 3}
provides explicit support for control functions.

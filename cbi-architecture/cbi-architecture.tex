...
simulation, for instance a Cranc-Nicolson solver can multiply the
...
simulators, such as GENESIS 2, that do not make a explicit distinction
between internal data structures for model represenation and
computation, and consequently often generate redundant data during the

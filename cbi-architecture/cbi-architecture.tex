...
design as it is specific to a given business application and the business
...
technology applications\marginpar{needs further explanation and / or citations}.  These highly developed layers\marginpar{what layers?} in the
...
languages by implementation of a new database interface software component.
...
implemented using procedural paradigms\cite{ray08:_pymoos,
  davison08:_pynn}.  This approach requires the

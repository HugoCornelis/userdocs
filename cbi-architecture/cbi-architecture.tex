...
user-workflow and provides a richer user-experience\marginpar{cite
...
In traditional enterprise software applications the lowest layer
consists of database back-ends.  However the CBI architecture has
solvers and communication infrastructures as back-ends.  The mapping
implemented by the intermediate layer determines how easy it is to
implement a given user-workflow that may be specific to a research
project or educational tutorial.  The first simple steps to understand
this mapping have been taken with as a consequence that its structure
is largely unknown.  The best examples we are aware of are

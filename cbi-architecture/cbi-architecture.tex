...
periphery control code that is unrelated to the biology it tries to
represent.
%The result is that
...
Therefore we first introduce a comprehensive user workflow that can be
used by simulator users as a guide to separate and distinguish the
important parts of their scripts.

The user workflow distinguishes the object under investigation from
the tools used to perform the investigation, from the operations

...
The CBI architecture provides a meta-framework for software development that defines a fully
functioning simulator. It was developed on the basis of an {\it ideal user
workflow} and an analysis method referred to as a {\it separation of
concerns}. The software {\it modules} resulting from
this analysis are then described.  The CBI architecture is the principled result of a
...
through the use of high level {\it scripting languages}.
...
becomes a much more physical reality.  As the {\it API}s of this
...
The relationship between the activities involved in conducting an experiment and running a simulation in computational biology is illustrated in Figure\,\ref{fig:data-flows}. These two iterative processes are connected by a feedback loop that employs interpretation of results as an {\it iterator}\marginpar{is this iterator used in a different meaning?} to design new experimental setups and model constructions.\\

...
A (G)UI translates user actions into a family of events that propagate to the components of a software architecture. They impact
their internal state, and define the overall behaviour of the software
system.  These events also direct the different components to pass data
between themselves.  In this section we explain how user actions and

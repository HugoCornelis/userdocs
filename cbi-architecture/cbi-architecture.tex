...
This is in sharp contrast with the CBI architecture.  Through its {\tt
  Scripting\,Libraries} and {\tt Controllers\,Communication}
functionality it\marginpar{Need to replace Communication components
  with the appropriate modules in Fig. 3} provides explicit support

...
that rich data flows occur between software components, but not within
them.  The actions a user takes are translated into events in the
software system.  These events impact the state of software
components, and direct components to pass data between one another.

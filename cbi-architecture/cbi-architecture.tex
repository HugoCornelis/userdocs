...
Figure\,\ref{fig:cbi-architecture-expanded} provides an expanded view of Figure\,\ref{fig:cbi-architecture-simple} and illustrates in more detail the relationships between the different modules and sub-modules that comprise the CBI architecture. We now introduce their functionality and describe their relationships within the context of an ideal user workflow.\\

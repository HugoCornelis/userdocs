...
independence of the {\tt Solvers} in the CBI architecture allows a
solver implementation to serialize its internal state to a file for
later resumption of a simulation.

...
A monolythic software application is comprised a set of tightly
...
software products.  By contrast a federated software design allows
different individuals to work in parallel on the same software
...
A software architecture is a collection of software modules where each
modules implements one or more concerns, but no concern is implemented

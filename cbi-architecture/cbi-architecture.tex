...
important aspects of the control code of the simulator software.
The workflow allows a user to make distinctions between an object under investigation,
the tools used to perform the investigation, and the operations

...
software components.  Therefore we have developed an adequate
framework for documentation.  This framework allows users as well as
developers to step in to help to grow the CBI federated framework in

...
\caption{ {\bf Overview of a federated software architecture:} Graphical
  ...
  architecture: the data cycles between the upper layers and
  lower layers.  Ultimately the two layers team to implement a single simulation.  By design any type of model including multi-scale models
...
\caption{ {\bf Detailed view of the Computational Biology Initiative
    federated software architecture.} Illustration of the sub-modules
  and their relationships within each of the function modules given in

...
user workflow,\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){600}}
  \end{picture}
} users combine models and experimental data that are
...
simulators, e.g. GENESIS 2.\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){600}}
  \end{picture}
} Such simulators do not make an explicit
...
numerical data. This\marginnote{
  \begin{picture}(0,0)
    \put(-10,10){\line(0,-1){40}}
  \end{picture}
} ultimately prevents the implementation of

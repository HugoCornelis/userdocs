...
{\it PerfectClamp} is part of the Heccer package and takes two options, one for an identifier and one for a filename which points to a file containing event data.
...
This {\it inputs} block tells SSP to connect the {\it PerfectClamp} to the component {\it /Purkinje/segments/soma}

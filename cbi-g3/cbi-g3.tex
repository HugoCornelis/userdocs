...
\subsubsection*{Monolythic Software}

A {\it monolythic software application} is comprised a set of tightly
...
% examples of monolythic interactions in G-2
%
% C-level hsolve implements a global namespace
%
% C-level direct connections between synchans and hsolve.
%
% SLI-level simulation clock (low-level control block) modifies model parameters such as CM

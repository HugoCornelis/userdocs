...
In the paradigm of the CBI architecture, model parameters are stored
and processed separately from stimulus protocols and the way
simulations are run.  As examples of the added functionality this
approach provides, we have shown how to run a simple model using {\bf
  Heccer} and the ability of the {\bf Model\,Container} to query the
...
a Purkinje cell model.  This greatly facilitates the development and
maintenance of individual G-3 components.

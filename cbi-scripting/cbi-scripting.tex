...
<opening sentence>
As examples of this scripted integration we have shown how to run a
...
a Purkinje cell model.  However in the paradigm of the CBI
architecture, model parameters are stored and processed separately
from stimulus protocols and the way simulations are run.  This

...
({\bf HUGO:} As of Febuary 2011 Python is now the 4th most popular language on the Tiobe Programming
Community Index and rising, It is currently the highest ranked
scripting language to date. http://www.tiobe.com/index.php/content/paperinfo/tpci/index.html). 

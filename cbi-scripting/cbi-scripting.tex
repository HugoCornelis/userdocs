...
(1) Generate and run a simple single-compartment model neuron\footnote{We use the segment for a dendritic extension and a the term compartment for its numerical representation} connected to a 
...
#------------------------------------------------------------------------------
# Create a model container with a segment
#------------------------------------------------------------------------------

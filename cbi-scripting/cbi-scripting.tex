...
construction to facilitate network modeling\marginpar{incorporate DES
...
to the function.  For convenience, we call this Python module\,{\it
  example}.\marginpar{{\bf Hugo:} you may want to check that the text matches the following example. {\bf NOTE:} Units {\tt RM}, {\tt RA}, and {\tt CM} do not appear to be SI.}

\begin{verbatim}
"""
Working script example for running a model with G3 via python.

...
Installation and maintenance of the GENESIS documentation system is fully automated with \href{../version-control/version-control.pdf}{document versioning} under the control of \href{http://monotone.ca/}{monotone}. 

\subsection*{Overview}

In its simplest form, the GENESIS documentation version control system can be seen as having three levels (see figure in \href{../version-control/version-control.pdf}{Version Control}):
\begin{enumerate}

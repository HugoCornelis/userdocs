...
\begin{figure}[h]
  \centering
 \includegraphics[scale=0.35]{figs/kde-gnxbar.eps}
  %\caption{enumerate}
...
\begin{figure}[h]
  \centering
 \includegraphics[scale=0.35]{figs/gnomebar-term.eps}
  %\caption{enumerate}
...
\begin{quote}
	\includegraphics[width=0.05\textwidth]{figs/redhat-main-menu32.eps} {\bf Red Hat main menu}\\
	 \includegraphics[width=0.05\textwidth]{figs/kmenu.eps} {\bf KDE main menu}\\
	 \includegraphics[width=0.05\textwidth]{figs/gnome-logo-icon32.eps} {\bf GNOME main menu}\\

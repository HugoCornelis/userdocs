...
\begin{verbatim}
   related-<your-tag>
\end{verbatim}
where $<$your-tag$>$ is replaced by an identifier you create. This tag must also be placed in the {\it descriptor.yml} file (see next section) for the reference hyperlink to work.
...
\item {\bf Insert reference hyperlink tags:} If reference hyperlink tags have been inserted into the source document then the same tags must be placed in the {\it descriptor.yml} file.

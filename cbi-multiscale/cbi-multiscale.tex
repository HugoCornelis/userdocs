...
connectivity provided by these individual modules. Their behavior is now described within the context of a user workflow (for more detail see \cite{10.1371/journal.pone.0028956}).
...
Solvers currently available in G-3, starting at the highest scale, include:

1) {\bf DES}, for discrete event queuing and distribution, {\bf Heccer}, a single neuron solver, {\bf Chemesis-3}, solves simple reaction-diffusion systems, and {\bf Experiment}, provides current injections, time-tables, and output.

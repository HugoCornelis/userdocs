...
distinction between the variables and parameters of a physical
process.  For instance the previous example neither defines the {\tt
  LENGTH} as a parameter with a fixed value nor as a solved variable.

...
\section*{The CBI Simulator Framework in a Multi-Scale Simulator}

\begin{flushleft}
{\Large
\textbf{The CBI Simulator Framework in a Multi-Scale Simulator}
}
...
James M. Bower$^{5}$.
\\
\bf{1} Cornelis H. Department of Neurophysiology, Catholic University of Leuven, Leuven, 3000, Belgium
\\
\bf{2} Coop A. D. Director of Flight Simulation, Merindah Energy.
\\
\bf{3} Rodriguez A. L. Research Imaging Institute, University of Texas Health Science Center at San Antonio, San Antonio, TX, United States
\\
\bf{4} David Beeman Department of Electrical, Computer, and Energy Engineering, University of Colorado, Boulder, CO 80309
\\

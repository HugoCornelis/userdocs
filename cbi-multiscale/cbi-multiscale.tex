...
The matrix implicit in Figure \ref{fig:mental-model-simulation-path} reveals a relationship between the cognitive and user workflows and the schemas outlined above. Here, we use these relationships to develop a novel and simplifying approach to the simulation of multi-scale models. 
...
results in a non-scalable software architecture \cite{jaeger02:_comput_neuros_realis_model_exper}.
 ...
 The CBI architecture was designed and developed in an effort to resolve the complexities associated with continual addition of functionality to simulators. As illustrated in Figure \ref{fig:cbi-architecture-simple}, the relationships between simulator control and data modules in such a federated architecture are symbolized by the relationship between high level biological concepts and their mathematical implementation. Diagonal interactions are forbidden as they foster the mixing of functionality across different levels that ultimately leads to the creation of monolithic software applications.

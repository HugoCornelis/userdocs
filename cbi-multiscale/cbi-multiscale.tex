...
However, the integration of the user workflow into G-3 allows the {\bf
  Heccer} instances, once created, to share internal data structures
as required, thereby reducing overall memory consumption.

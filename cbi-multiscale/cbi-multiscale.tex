...
required for the simulation of network models.  Action potentials
generated at the soma of one neuron are translated to a discrete event
that is delivered to the post-synaptic targets of the connected
neurons.

{\bf DES} is capable of associating 'secondary' data with a
connection, such as propagation delay, synaptic weight, or other
data specific for the model.

{\bf DES} can queue a single event and deliver it to many targets.
...
efficient way.  The event distributor is part of the CBI {\bf

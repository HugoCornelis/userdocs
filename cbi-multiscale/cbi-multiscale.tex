...
During a simulation, the addressing scheme algorithm enables the {\bf Solvers} and the {\bf Communication Infrastructure} to
relate their equivalent variables these components contain.  As
this happens during a simulation, the addressing scheme must be
highly optimized to maximize run-time performance.

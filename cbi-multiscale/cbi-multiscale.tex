...
models ranging from subcellular dynamics up to the network level. Loosely\marginpar{need to integrate this para.} based on GENESIS-2 elements \cite{bower98:_book_genes}, the {\bf Biology\,Model\,Container} supports tokens for: Grid3D, Populations, and Networks; VolumeConnect, Individual Connections; Single Cells and Morphology; HH-Channels and Synaptic (NMDA/AMPA) Channels, and Reaction--Diffusion.
...
The {\bf model-container} needs appropriate configuration to recognize
the NDF tokens supported by {\bf Chemesis-3}\marginpar{incomplete}.

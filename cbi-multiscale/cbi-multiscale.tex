...
lead to the implementation of {\bf Chemesis-3} as a stand-alone {\bf
  Solver} of G-3.  The functions currently implemented in the core of
...
given in three small text files: {\it kinetics.yml}: supports the
definition of groups of pools of molecules and their chemical
interactions, {\it reaction.yml}: supports the definition of reactions
...
The Neurospaces {\bf Studio} is a GUI front-end to the {\bf Model
  Container} and allows browsing and visualization of a model.  Note
that the {\bf Studio} is not a graphical editor or construction kit.
External applications such as {\bf neuroConstruct} should be employed
for these purposes\cite{gleeson07}.

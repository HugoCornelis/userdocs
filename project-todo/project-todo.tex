...
Diagnosis of problem and documented procedure for troubleshooting the Inline::Python module is found in \href{../genesis-dependencies/genesis-dependencies.tex}{GENESIS dependencies} document, in the {\it Note about Inline::Python} section. (DONE)

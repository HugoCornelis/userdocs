...
\subsection{Descriptor file tags recognized by {\it neurospaces\_cron}}

The following tags should be recognized for the alpha release to allow documentation in the given formats to be recognized when placed in the documentation folder (c.f. the {\it figures} folder).
\begin{itemize}
   \item[]{\bf - html} Hypertext markup language.
    \item[]{\bf - png} Portable network graphics.
    \item[]{\bf - ps} Postscript.
\end{itemize}
The following tag should also be recognized
\begin{itemize}

...
\title{Principles, workflows, and a heterarchical framework for effective resolution of scale-independent model simulation in computational neuroscience}

\author[a,1]{Hugo CORNELIS} 
\author[b]{Allan D. COOP} 

\address[a]{\noindent Neurospaces, blah, blah, blah}
...
\put(-12,-850.4799){\includegraphics[width=47.64pt,height=875pt]{JMN_image.png}}
\put(67,-30.0){\fontsize{14.04052}{1}\usefont{T1}{cmr}{b}{n}\selectfont\color{color_197966}Perspective}%% Original Research/Review/Perspective}
...
\put(490.76,-50.0){\includegraphics[width=38.28pt,height=38.28pt]{Neuralpress_image1.png}}
...
The biological systems intrinsic to multicellular organisms are inherently complex and comprised of numerous functional cellular webs that operate across diverse internal domains to sustain development, growth and reproductive potential. Such systems extend from the most basic of amino acid substitutions that alter protein function to concerted multicellular signaling cascades regulating hormone releases that modulate behaviour throughout an entire lifecycle. Computational models are uniquely positioned to capture the interactivity between these divergent components of biological function as they bridge the gap in understanding between isolated {\it{in vitro}} experiments and whole-organism behavior.

While both seemingly transparent and widely accepted, a careful definition of the term multiscale should be identified as it is a notion that very quickly spirals into a realm of catch-all scientific jargon. Such freedom is clearly encouraged by absence of the term from \textit{The Encyclopedia of Computational Neuroscience}~\citep{jung22}, where nine years after its initial publication there is neither section nor article devoted to multiscale simulation. More trivially, the term appears on ten occasions in the 3,663 pages of the second edition and also in a total of twelve publication titles cited in post article References of the Encyclopedia.
...
\begin{figure}[h!t]
  \begin{center}
    \includegraphics[width=0.45\textwidth]{figures/multi-scale-taxonomy-no-arrows-no-texts.eps}
  \end{center}

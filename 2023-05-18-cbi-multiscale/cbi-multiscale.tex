...
\newcommand*{\marginfootnote}[1]{\marginpar{\singlespacing \footnotesize #1}}

\begin{document}

\begin{flushleft}
{\Large
\textbf{CBI Simulator Framework: Multiscale modelling with multiple solvers}
}

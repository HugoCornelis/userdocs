...
Two notable exceptions that attempted to deal with this problem were the GENESIS-2 and NEURON simulators.  The architecture of GENESIS-2 facilitated an object-oriented programming paradigm where the objects in the simulator represented biological concepts in the real world. An important advantage of this approach was that it allowed for easy parallelization of simulations~\citep{cornelis07a}\marginpar{\scriptsize bad citation}\marginpar{\scriptsize sandberg08 had two minor problems}. However, a significant problem was that this approach also matched biological concepts with the mathematical implementation. Consequently, the simulator exposed considerable technical detail to the user, making it difficult to use.
...
\bibliography{../tex/bib/2023-07-29-g3-refs-adc-1}

...
The general idea behind this configuration is to provide G-3 with
different interface profiles.  Examples of such interface profiles
...
\item An interface to a model database via the model-container and the
  tools that connect to it.  The neurospaces studio is an example of
  this capability.

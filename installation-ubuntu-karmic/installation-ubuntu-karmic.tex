...
strongly recommended to install the dependencies of the G-Tube:
...
\item sdl-perl
\end{itemize}
After successful installation of the Neurospaces studio, issue the
shell command 'neurospaces cells/purkinje/edsjb1994.ndf --gui' to see
if its graphical part works correctly.

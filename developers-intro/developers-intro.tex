...
\end{itemize}
The \href{../developer-package/developer-package.tex}{\it DeveloperPackage} has built in support for this directory.
% structure when
...
You can go to the directory of each software component and
configure, compile, check, and install each package individually. The
\href{../developer-package/developer-package.tex}{\it DeveloperPackage} has built in support to automate these actions, while
respecting the dependencies between packages (i.e. each of the
...
\item {\bf A simple build for the packages: model-container, heccer, and ssp, on a developer machine:}
\begin{verbatim}
...
The \href{../developer-package/developer-package.tex}{\it DeveloperPackage} has many more tools for GENESIS software development.  For
more information, see the details of the {\it DeveloperPackage}.
...
\end{verbatim}
  ...
  found, the build order, and version control information (Note:

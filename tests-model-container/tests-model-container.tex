...
For more details see the \href{../medel-container/model-container.tex}{\bf Model\,Container} documentation.

\subsection*{Obtaining Regression Test Specifications}

This \href{http://neurospaces.sourceforge.net/neurospaces_project/neurospaces/tests/html/index.html}{\bf link} accesses all regression test specifications for the {\bf Model\,Container}.

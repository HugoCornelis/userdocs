...
\begin{itemize}
\item[] {\bf Admin:} Mando
\item[] {\bf Date:} 1/7/2010 
\item[] {\bf Actions:} Removed the neurospaces_project directory and did a fresh pull.
\item[] {\bf Reason:} Due to several file moves done during the python swig bindings the tester could not properly update the workspace. Also permissions on test scripts were not updating with new cron runs.

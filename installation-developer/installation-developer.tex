...
{\bf Note:} The GENESIS \href{../ndf-file-format/ndf-file-format.tex}{NDF file format} has a special\,{\it elisp} package for use with\,{\it (x)emacs} that is installed as a part of the {\bf Model\,Container} package.
...
A GENESIS 3 developer keeps his developer resources in the directory
...
\href{../genesis-components/genesis-components.tex}{software
  components} he is currently developing.
...
for the \href{../version-control/version-control.tex}{version control
  systems} that require a dedicated directory for this.  {\bf
...
\href{http://www.emacswiki.org/emacs/OutlineMode}{outline major mode}.

...
\paragraph{\bf Each software component has several resources:} For example, source code, documentation, additional tools, etc.  The script {\it neurospaces\_propagate\_tools} is used to propagate updates to source code of shared tools from source to target packages.

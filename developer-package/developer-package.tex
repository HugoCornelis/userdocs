...
\end{figure}
   ...
   \item {\bf Installation Order of Packages:} This is the package order in the {\it neurospaces\_build} associative array:
   \begin{enumerate}
      \item {\it Developer} {\bf Package:} Described in this documentation.

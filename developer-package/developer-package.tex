...
\begin{enumerate}
   ...
   \begin{itemize}
      ...
      \item {\it neurospaces\_upgrade}\,\,\,Pulls code from the GENESIS repositories and calls {\it neurospaces\_update}.
   \end{itemize}
...
\end{itemize}
   ...
   \begin{itemize}
      ...
      \item \href{../neurospaces\_cron/neurospaces\_cron.tex}{\it neurospaces\_cron}\,\,\,A {\it cron} job based tester script. 

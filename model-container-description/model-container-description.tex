...
The functional core of the model-container is the implementation of a
graph data structures data structure that efficiently represents and
stores repititive data with small variations in structure or quantity
parameters:
\begin{enumerate}

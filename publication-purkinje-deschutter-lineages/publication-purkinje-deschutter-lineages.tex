...
Here, we give the lineage of the various components reported for the De Schutter \& Bower Purkinje cell model:
\begin{itemize}
...
\begin{itemize}
   \item Crepel F \& Penit-Soria J (1986) Inward rectification and low threshold calcium conductance in rat cerebellar Purkinje cells. An in vitro study. {\it Journal of Physiology.} (Lond.). {\bf 372}: 1--23.
   
   \item Gruol DL, Jacquin T \& Yool AJ (1991) Single-channel K$^+$currents recorded from the somatic and dendritic regions of cerebellar Purkinje neurons in culture. {\it Journal of Neuroscience.} {\bf 11}: 1002--1015.
   
   \item Spain WJ, Schwindt PC \& Crill WE (1987) Anomolous rectification in neurons from cat sensorimotor cortex in vitro. {\it Journal of Neurophysiology.} {\bf 57}: 1555-1576.
      \begin{enumerate}
         \item The ionic mechanisms underlying anomalousrectification in large neurons from layerV of cat sensorimotor cortex were studied inan in vitro brain slice. The anomalous rectificationwas apparent as an increase of slopeconductance during membrane hyperpolarization,and the development of anomalousrectification during a hyperpolarizing currentpulse was signaled by a depolarizing sag ofmembrane potential toward resting potential(RP).         \item Voltage-clamp analysis revealed thetime- and voltage-dependent inward current($I_{AR}$) that produced anomalous rectification.$I_{AR}$ reversal potential ($E_{AR}$) was estimated tobe $\sim$\,-50\,mV from extrapolation of linear,instantaneous, current-voltage relations.         \item The conductance underlying $I_{AR}$ ($G_{AR}$)had a sigmoidal steady-state activation characteristic.$G_{AR}$ increased with hyperpolarizationfrom -55 to -105\,mV with half-activationat $\sim$ -82 mV.         \item The time course of both $G_{AR}$ and $I_{AR}$ during a voltage step was described by two exponentials.The faster exponential had a timeconstant ($\tau_F$) of $\sim$\,40 ms; the slow time constant($\tau_S$) was $\sim$ 300\,ms. Neither $\tau_F$ nor $\tau_S$changed with voltage in the range -60\,mV to-110\,mV. The fast component constituted$\sim$\,80\,\% of $I_{AR}$  at each potential.         \item Both $I_{AR}$  and $G_{AR}$ increased in raised extracellularpotassium ([K$^+]_o$,) and $E_{AR}$ shiftedpositive, but the $G_{AR}$ activation curve did notshift along the voltage axis. Solutions containingan impermeable Na$^+$ substitute caused aninitial transient decrease in $I_{AR}$ followed by aslower increase of $I_{AR}$. Brain slices bathed inNa$^+$-substituted solution developed a gradualincrease in [K$^+]_o$ as measured with K$^+$-sensitivemicroelectrodes. We conclude that $G_{AR}$ ispermeable to both Na$^+$ and K$^+$, but the fullcontribution of Na$^+$ was masked by the slowincrease of [K$^+]_o$ that occurred in Na$^+$ substitutedsolutions.         \item Chloride did not appear to contributesignificantly to $I_{AR}$ since estimates of $E_{AR}$ weresimilar in neurons impaled with microelectrodesfilled with potassium chloride or methylsulfate,whereas, $E_{Cl}$ (estimated from reversalof a GABA-induced ionic current) was $\sim$\,30\,mV 
more positive with the KCl-filled microelectrodes.         \item Extracellular Cs$^+$ caused a reversibledose- and voltage-dependent reduction of $G_{AR}$,whereas intracellular Cs$^+$ was ineffective.         \item The parameters measured during voltageclamp were used to formulate a quantitativeempirical model of $I_{AR}$. The model faithfullyreproduced measured current and voltage responsesand was used to estimate the variationof $I_{AR}$ in situations that were difficult to examineexperimentally. The results of thesecomputations suggest that $I_{AR}$ can contributeto spike repolarization, spike frequency adaptation,and afterhypolarization magnitudeand duration.
...
\item {\bf Delayed rectifier ($K_{dr}$):}
   \begin{itemize}
      ...
      \item Yamada WM, Koch C \& Adams PR (1989) Multiple channels and calcium dynamics. In: Koch C \& Segev I (eds.). {\it Methods in Neuronal Modeling: From Synapses to Networks.} MA: MIT Press. pp. 97--133. 

   \end{itemize}

\item {\bf Persistent potassium current ($K_m$):}
   \begin{itemize}
      \item Bossu JL, Dupont JL \& Feltz A (1989) Calcium currents in rat cerebellar Purkinje cells maintained in culture. {\it Neuroscience.} {\bf 30}: 605--617.    
      \item Hirano T \& Hagiwara S (1989) Kinetics and distribution of voltage-gated Ca, Na, and K channels on the somata of rat cerebellar Purkinje cells. {\it Pfl\"ugers Archiv}. {\bf 413}: 463--469.
     \item Yamada WM, Koch C \& Adams PR (1989) Multiple channels and calcium dynamics. In: Koch C \& Segev I (eds.). {\it Methods in Neuronal Modeling: From Synapses to Networks.} MA: MIT Press. pp. 97--133. 
...
\begin{itemize}
   \item Connor JA \& Stevens CF (1971) Voltage clamp studies of a transient outward membrane current in gastropod neural somata. {\it Journal of Physiology.} (Lond.). {\bf 213}: 21--30.
     \item De Schutter E (1986) Alternative equations for the molluscan ion currents described by Connor and Stevens. {\it Brain Research.} {\bf 382}: 134--138.
      \item Hirano T \& Hagiwara S (1989) Kinetics and distribution of voltage-gated Ca, Na, and K channels on the somata of rat cerebellar Purkinje cells. {\it Pfl\"ugers Archiv}. {\bf 413}: 463--469.
     \item Li SJ, Wang Y, Strahlendorf HK \& Strahlendorf JC (1990) A transient voltage-dependent outward current recorded from rat cerebellar Purkinje cells under voltage clamp. {\it Society for Neuroscience Abstracts.} {\bf 16}: 507.
   
\end{itemize}

\item {\bf Calcium-activated potassium current  ($K_C$):}
\begin{itemize}
   \item Traub RD, Wong RKS, Miles R \& Michelson H (1991) A model of a CA3 hippocampal pyramidal neuron incorporating voltage-clamp data on intrinsic conductances. {\it Journal of Neurophysiology.} {\bf 66}: 635--650.
   \item Gola M, Ducreux C \& Chagneux H (1990) Ca$^{2+}$-activated K$^+$ current involvement in neuronal function revealed by in situ single-channel analysis in {\it Helix} neurones. {\it Journal of Physiology} (Lond.). {\bf 420}: 73--109.
   \item Gruol DL, Jacquin T \& Yool AJ (1991) Single-channel K$^+$currents recorded from the somatic and dendritic regions of cerebellar Purkinje neurons in culture. {\it Journal of Neuroscience.} {\bf 11}: 1002--1015.
   \item Franciolini F (1988) Calcium and voltage dependence of single Ca$^{2+}$-activated K$^+$ activated channelsfrom cultured hippocampal neurons of rat. {\it Biochimica et Biophysica Acta.} {\bf 93}: 419--427.

...
\begin{itemize}
\item[] \href{http://bouml.free.fr}{\bf bouml}: A freeware cross platform UML diagramming software.
\item[] \href{http://sourceforge.net/projects/eclipse-pyuml/}{\bf PyUML}: An eclipse plugin that can "round trip" Python code.

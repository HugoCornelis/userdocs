...
Currently, there are two types of GENESIS installation: (A) User and (B) Developer. Typically, for both types, once your machine is correctly configured and any missing \href{../genesis-dependencies/genesis-dependencies.tex}{GENESIS software dependencies} are installed on your machine the process of installing GENESIS is highly automated.

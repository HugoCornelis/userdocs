...
\begin{enumerate}
   \item{\bf User Workflow:}\\Selecting the ``User Workflow'' tab presents the User Workflow panel that contains the following selectable menu items (see Fig. \ref{fig:wf-user-1}).
